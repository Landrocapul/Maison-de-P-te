    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="bg-white bg-opacity-90 backdrop-blur-sm py-8 px-6 shadow-2xl rounded-lg animate__animated animate__fadeInUp">
                <?php if ($message): ?>
                    <p class="text-<?php echo isset($_GET['registered']) ? 'green' : 'red'; ?>-500 mb-4 text-center"><?php echo $message; ?></p>
                <?php endif; ?>
                <form method="post" class="space-y-6">
                    ...
                    <div>
                        <button type="submit" class="w-full bg-[#4c2b1b] text-white py-2 px-4 rounded-md hover:bg-[#3a1f14] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4c2b1b] transition duration-300 animate__animated animate__pulse">Sign in</button>
                    </div>
                </form>
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">Don't have an account? <a href="register.php" class="font-medium text-[#4c2b1b] hover:text-[#3a1f14] transition duration-300">Register here</a></p>
                </div>
            </div>
        </div>
    </div>
